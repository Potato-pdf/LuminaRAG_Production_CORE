...
class IndexService:
    ...
    def _index_to_faiss_collection(self, empresa: str, private: bool,
        ...
        logger.info(f"💾 Colección {collection_name} guardada localmente: {faiss_path}")
        
        # Subir a S3 para persistencia
        self._upload_to_s3(collection_name, faiss_path, metadata_path)
        
        return collection_name
    
    def _upload_to_s3(self, collection_name: str, faiss_path: Path, metadata_path: Path):
        """Subir índice FAISS y metadata a S3"""
        import boto3
        ...
        try:
            ...
            s3_client.upload_file(str(faiss_path), bucket, s3_faiss_key)
            ...
            s3_client.upload_file(str(metadata_path), bucket, s3_metadata_key)
